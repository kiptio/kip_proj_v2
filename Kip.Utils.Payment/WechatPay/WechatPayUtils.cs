using Kip.Utils.Payment.WechatPay.Models;
using System;
...
namespace Kip.Utils.Payment.WechatPay
{
    public class WechatPayUtils
    {
        ...
        public static string getNoncestr()
        {
            ...
            return PaymentTools.GetMD5(random.Next(1000).ToString(), "GBK").ToLower().Replace("s", "S");
        }
        ...
        public string getsign(SortedDictionary<string, string> sParams, string key)
        {
            ...
            sign = PaymentTools.GetMD5(signkey, "utf-8");
